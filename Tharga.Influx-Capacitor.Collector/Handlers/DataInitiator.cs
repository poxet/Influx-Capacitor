...
namespace Tharga.InfluxCapacitor.Collector.Handlers
{
    public class DataInitiator
    {
        ...
        {
            var response = new CounterGroup(groupName, secondsInterval, refreshInstanceInterval, counters, new ITag[] { }, collectorEngineType, null);
        ...
        private Tuple<string, OutputLevel> CreateProcessorCounter()
        {
            ...
            var response = new CounterGroup(name, 10, 0, counters, new ITag[] { }, CollectorEngineType.Safe, null);
