...
namespace Tharga.InfluxCapacitor.Collector.Business
{
    public class SendBusiness : ISendBusiness
    {
        ...
        public SendBusiness(IConfigBusiness configBusiness, IInfluxDbAgentLoader influxDbAgentLoader)
        {
            //configBusiness.clien
            //influxDbAgentLoader.GetAgent()

            var senderAgent = new InfluxDbSenderAgent();
            var queueEvents = new QueueEvents();
            var queueSettings  = new QueueSettings();

            _queue = new InfluxCapacitor.Queue(senderAgent, queueEvents, queueSettings);
        }
